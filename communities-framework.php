...
//				}
		...
		case "notifications":
			...
			if ( $member_count > 0 || is_super_admin() ) {
                ...
                <p class="submit">
                <input class="button-primary" type="submit" name="Submit" value="<?php _e('Save Changes', $communities_text_domain) ?>" />
                </p>
                </form>
				<?php
			}
		...
		case "leave_community":
            ...
            <p class="submit">
            <input class="button-secondary" type="submit" name="Cancel" value="<?php _e('Cancel', $communities_text_domain) ?>" />
            <input class="button-primary" type="submit" name="Submit" value="<?php _e('Continue', $communities_text_domain) ?>" />
            </p>
            </form>
            <?php
		break;
		...
		case "message_board":
			...
			if ( $member_count > 0 || is_super_admin() ) {
                ...
                <p class="submit">
                <input class="button-primary" type="submit" name="Submit" value="<?php _e('Post', $communities_text_domain) ?>" />
                </p>
                </form>
                <?php
			}
		...
		case "new_page":
			...
			if (  $member_moderator == '1' || is_super_admin() ) {
                ...
                <p class="submit">
                <input class="button-secondary" type="submit" name="Cancel" value="<?php _e('Cancel', $communities_text_domain) ?>" />
                <input class="button-primary" type="submit" name="Submit" value="<?php _e('Publish', $communities_text_domain) ?>" />
                </p>
                </form>
                <?php
			}
...
*/		
	...
	?>
		<form name="create_community" method="POST" action="?page=add-communities&amp;action=create_community">
			...
			<p class="submit">
			<input class="button-primary" type="submit" name="Submit" value="<?php _e('Create', $communities_text_domain) ?>" />
			</p>
		</form>
	</div>
	<?php
	...
	switch( $_GET[ 'action' ] ) {
		...
		default:
            ...
            <p id="post-search">
                ...
                <input class="button-secondary" value="<?php _e('Search', $communities_text_domain) ?>" class="button" type="submit">
            </p>
            </form>
            <?php
			if ($search_terms != ''){
		...
		case "join_community":
			...
			if ( $community_private != '1' ) {
                ...
                <p class="submit">
                <input class="button-secondary" type="submit" name="Cancel" value="<?php _e('Cancel', $communities_text_domain) ?>" />
                <input class="button-primary" type="submit" name="Submit" value="<?php _e('Join', $communities_text_domain) ?>" />
                </p>
                </form>
				<?php
			}
